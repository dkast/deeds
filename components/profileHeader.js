    ...
    <>
      {user && (
        <>
          <div className="hero -mt-20 -mx-2 pt-4 pb-16">
            <div className="text-center mt-10">
              <Avatar
                ...
                bgColor={user.color}
                size="xl"
                className="mx-auto border-2 border-indigo-100"
              />
              <div className="text-indigo-100 text-2xl mt-2">{user.name}</div>
            </div>
          </div>
          <div className="flex items-center justify-center bg-white dark:bg-gray-900 p-4 -mt-8 w-1/2 rounded shadow-lg mx-auto">
          ...
          <div className="p-4">
            <h2 className="text-2xl text-gray-600">Actividad</h2>
          </div>
        </>
      )}
      <style jsx>
